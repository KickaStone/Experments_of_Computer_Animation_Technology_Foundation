...
int main()
{
	...
	// --------------------
	GLFWwindow* window = glfwCreateWindow(800, 600, "test3", NULL, NULL);
	if (window == NULL)
	{
	...
	std::cout << "鼠标输入四个控制点，按回车生成曲线" << std::endl;
	//use Shader class
	Shader ourShader("E:\\Solutions\\Experments_of_Computer_Animation_Technology_Foundation\\test3\\shaders\\test3.vs",
		"E:\\Solutions\\Experments_of_Computer_Animation_Technology_Foundation\\test3\\shaders\\test3.fs");
